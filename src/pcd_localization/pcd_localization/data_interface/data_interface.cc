...
void DataInterface::PublishSensorTrans(const StampedTrans& sensor_trans) {
...
const StampedTrans& DataInterface::ListenFrameToSensor(
    const std::string& frame) {
  static tf2_ros::Buffer tf2_buffer;
  static tf2_ros::TransformListener tf2_listener(tf2_buffer);
  static StampedTrans sensor_trans(ros::Time(), Eigen::Vector3f(0, 0, 0),
